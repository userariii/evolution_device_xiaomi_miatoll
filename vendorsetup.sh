# Device Common Tree
git clone --depth=1 https://github.com/SuperiorOS-Devices/device_xiaomi_sm6250-common.git -b 13 device/xiaomi/sm6250-common
...
# Kernel Tree
git clone --depth=1 https://github.com/SuperiorOS-Devices/kernel_xiaomi_sm6250.git -b thirteen kernel/xiaomi/sm6250
